                        ...
                        <ul className="space-y-8 text-base text-white/60 font-light">
                            <li className="flex items-center gap-6 group">
                                <div className="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center group-hover:bg-tambo-rose/20 transition-all duration-700">
                                    <Mail className="w-5 h-5 text-tambo-rose" />
                                </div>
                                <a href="mailto:tambobook@gmail.com" className="hover:text-tambo-lavender transition-colors tracking-widest uppercase text-xs font-bold">tambobook@gmail.com</a>
                            </li>
                            <li className="flex items-center gap-6 group">
                                <div className="w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center group-hover:bg-tambo-rose/20 transition-all duration-700">
                                    <Phone className="w-5 h-5 text-tambo-rose" />
                                </div>
                                <a href="tel:+420604561690" className="hover:text-tambo-lavender transition-colors tracking-widest uppercase text-xs font-bold">+420 604 561 690</a>
                            </li>
                        </ul>
                    </div>
